...
class TreeTest(unittest.TestCase):
    ...
    def test_EmptyRoot(self):
        ...
        self.assertEqual(0, rootNode.midPoint.x)
        self.assertEqual(0, rootNode.midPoint.y)
        self.assertEqual(5, rootNode.halfWidth)
        self.assertEqual(0, rootNode.particleCount)
        for c in rootNode.childNodes:
            self.assertIsNone(c)
        for c in rootNode.children():
            self.fail('There should be no childre')
    ...
    def test_SimpleTree(self):
        ...
        self.assertEqual(2, topLeftChild.particleCount)
        ...
        self.assertEqual(1, topLeftGrandChild.particleCount)
        ...
        self.assertEqual(1, topRightGrandChild.particleCount)
